    ...
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl w-full">
        <div className="text-center p-4">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">Hourly, daily, or custom</p>
        </div>
        <div className="text-center p-4">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">Runs automatically</p>
        </div>
        <div className="text-center p-4">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">View history anytime</p>
        </div>
      </div>
    </div>
  );
