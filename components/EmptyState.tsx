...
export default function EmptyState({ onCreateJob }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <p className="text-slate-700 dark:text-gray-400 text-center max-w-md mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl w-full">
        <div className="text-center p-4">
          ...
          <p className="text-sm font-medium text-slate-800 dark:text-gray-100">Set Schedule</p>
          <p className="text-xs text-slate-600 dark:text-gray-400">Hourly, daily, or custom</p>
        </div>
        <div className="text-center p-4">
          <Sparkles className="w-8 h-8 text-emerald-600 dark:text-emerald-400 mx-auto mb-2" />
          <p className="text-sm font-medium text-slate-800 dark:text-gray-100">AI Executes</p>
          <p className="text-xs text-slate-600 dark:text-gray-400">Runs automatically</p>
        </div>
        <div className="text-center p-4">
          <CalendarPlus className="w-8 h-8 text-emerald-600 dark:text-emerald-400 mx-auto mb-2" />
          <p className="text-sm font-medium text-slate-800 dark:text-gray-100">Track Results</p>
          <p className="text-xs text-slate-600 dark:text-gray-400">View history anytime</p>
        </div>
      </div>
    </div>
  );
